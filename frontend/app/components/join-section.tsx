...
export const JoinSection = () => {
  return (
    <section className="py-20 lg:pt-30 lg:pb-5">
      <div className="h-[500px] lg:h-[800px] bg-[url(https://images.unsplash.com/photo-1495785870240-c8456d5aeda2)] bg-cover bg-center rounded-lg flex flex-col justify-center items-center gap-7">
